...
async function fetchBotReply(outline) {
  const response = await openai.createCompletion({
    ...
    prompt: `Generate a short personalized message in English to enthusiastically say an outline sounds interesting and that you need some minutes to think about it. The message must reference something from the provided outline.
    ###
